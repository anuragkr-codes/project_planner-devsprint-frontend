        ...
        <div id='app' data-theme={dataTheme}>
            ...
            {/* <section className='landing-main'> */}
                <div className='landing-left'>
                    ...
                    <p className='landing-text'>Welcome to Project Pilot – your all-in-one project management solution. Allocate tasks, monitor progress, and collaborate seamlessly with our user-friendly platform. Experience efficiency like never before!</p>
                </div>
